                        ...
                        <div class="review-content-section">
                            ...
                            <select name="id_cargo" class="form-control pro-edt-select form-control-primary" required>
                                @foreach($cargos as $cargo)
                                    <option value="{{$cargo->id}}" {{ $dato->id_cargo == $cargo->id ? 'selected' : '' }}> {{$cargo->cargo}}</option>    
                                @endforeach
							</select>
                            ...
                            <select name="id_horario" class="form-control pro-edt-select form-control-primary" required>
                                @foreach($horarios as $horario)
                                    <option value="{{$horario->id}}" {{ $dato->id_horario == $horario->id ? 'selected' : '' }}> {{$horario->horario}}</option>    
                                @endforeach
							</select>
